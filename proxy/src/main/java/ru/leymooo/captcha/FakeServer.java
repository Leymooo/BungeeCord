...
public class FakeServer
{
    ...
    //========================================================================
    @Getter
    private final ConfirmTransaction transactionPacket = new ConfirmTransaction( (byte) 0, (short) 0, false );
    @Getter
    //Keep Alive можно отправить со значением - 0;
    private final KeepAlive keepAlivePacket = new KeepAlive(0);
    @Getter
    private final PlayerPositionRotation playerPositionPacket = new PlayerPositionRotation( 5.0D, 50.0D, 5.0D, 90.0F, 54.2F, 0, false );
    //========================================================================
    ...
    public void sendJoinPackets()
    {
        ...
        //PlayerAbilities можно не отправлять
        //entityEffectPacket тоже
